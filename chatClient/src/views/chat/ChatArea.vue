<template>
  <div class="chat-area__com">
    ...
    <div class="message-edit-container">
      <textarea placeholder="请输入您的消息..." ref="chatInp" class="textarea" v-model="messageText" maxlength="200" @input="scrollBottom = true" @keydown.enter="send($event)"></textarea>
      <div class="send-type">
        ...
        <label for="upfile">
          <el-tooltip class="item update-item" effect="dark" content="只能上传小于 2M 的文件" placement="top">
      ...
      <div
          ...
          @click="setShowHistoryMsg">历史记录</div>
